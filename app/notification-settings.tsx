...
type NotificationType = 'local_incidents' | 'us_incidents' | 'legal_updates' | 'civil_rights' | 'immigration' | 'policing';
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.scrollContent}>
        <View style={styles.section}>
          ...
          <View style={styles.frequencyOptions}>
            {(['hourly', 'daily', 'weekly'] as NotificationFrequency[]).map(frequency => (
              <TouchableOpacity
                key={frequency}
                style={[
                  styles.frequencyOption,
                  settings.notification_frequency === frequency && styles.selectedFrequency
                ]}
                onPress={() => setNotificationFrequency(frequency)}>
                <Text style={[
                  styles.frequencyText,
                  settings.notification_frequency === frequency && styles.selectedFrequencyText
                ]}>
        ...
        <View style={styles.section}>
          ...
          {Object.entries(settings.notification_types).map(([type, enabled]) => (
            <View key={type} style={styles.settingItem}>
              ...
              <Switch
                value={enabled}
                onValueChange={() => toggleNotificationType(type as NotificationType)}
