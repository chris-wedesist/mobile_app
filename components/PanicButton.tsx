      ...
      <>
        ...
        <View style={styles.container}>
          ...
          <button
            style={{
              ...styles.button,
              ...(isPressed && { backgroundColor: colors.status.error, transform: 'scale(0.95)' }),
              ...(isAlarmActive && { backgroundColor: colors.status.error, borderWidth: 3, borderColor: colors.text.primary }),
              border: 'none',
              cursor: 'pointer',
            }}
