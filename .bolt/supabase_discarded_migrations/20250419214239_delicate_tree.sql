/*
  ...
  1. New Table
    - `settings_audit_log`: Track all settings changes
      - Basic info (id, user_id, setting_changed)
      - Before/after values
      - Metadata about the change (platform, source, etc.)
      
  2. Features
    - Automatic logging via triggers
    - Platform and source tracking
